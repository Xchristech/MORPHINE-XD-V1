...
const config = {
  ...
  PREFIX: process.env.PREFIX || '.',
   BOT_NAME: process.env.BOT_NAME || "MORPHINE XD V1",
   BOT: process.env.BOT || "hello 👋",
  NEW_CMD: process.env.NEW_CMD || "ᴀᴅᴅᴠᴀʀ\n│ sᴜᴅᴏ\n| chris",
  CAPTION: process.env.CAPTION|| "ᴘᴏᴡᴇʀᴇᴅ ʙʏ chtis gaaju",
  ...
  DELETED_MESSAGES_CHAT_ID: process.env.DELETED_MESSAGES_CHAT_ID || "263783063469@s.whatsapp.net",
  OWNER_NAME: process.env.OWNER_NAME || "INCONNU BOY",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "263783063469",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "2348069675806",
